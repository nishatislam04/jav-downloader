#!/usr/bin/env python
# coding: utf-8
"""JAV Downloader CLI CLI downloader for Docker and NAS use — no GUI.
...
Examples:
  docker run --rm -v /nas/videos:/downloads ghcr.io/alos21750/jav-downloader https://jable.tv/videos/abc-123/
  docker run --rm -v /nas/videos:/downloads -e URLS_FILE=/downloads/urls.txt ghcr.io/alos21750/jav-downloader
"""
import os
import sys
...
def main():
    ...
    if not urls:
        print("no URL provided. Pass URL(s) as arguments, set the URLS env var, or add a"
              ...
              "  docker run --rm -v /nas/videos:/downloads ghcr.io/alos21750/jav-downloader <URL>", flush=True)
        return 2
